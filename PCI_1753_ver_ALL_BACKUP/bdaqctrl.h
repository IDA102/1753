...
__inline ErrorCode         AiChannel_getSensorScaleTable(AiChannel *obj, int32 *size, MapFuncPiece table[])                                { return DAQFN_ETT(DNLAPI_AI, 111, int32 *, MapFuncPiece *)(obj, size, table); }
__inline ErrorCode         AiChannel_setSensorScaleTable(AiChannel *obj, int32 size, MapFuncPiece table[])                                 { return DAQFN_ETT(DNLAPI_AI, 112, int32  , MapFuncPiece *)(obj, size, table); }
...
public:
   ...
   ErrorCode      getSensorScaleTable(int32 &size, MapFuncPiece table[]) { return AiChannel_getSensorScaleTable(this, &size, table);}
   ErrorCode      setSensorScaleTable(int32 size, MapFuncPiece table[])  { return AiChannel_setSensorScaleTable(this,  size, table);}
